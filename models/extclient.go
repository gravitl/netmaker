...
// ConvertToStaticNode converts an ExtClient to a Node suitable for static node operations.
func ConvertToStaticNode(ext *schema.ExtClient) Node {
	if ext.Tags == nil {
		ext.Tags = make(map[schema.TagID]struct{})
	}
	return Node{
