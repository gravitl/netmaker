...
var ssoErrCallbackTemplate = template.Must(
	...
	<body>
		...
		<em>
			Please visit the <a href="https://docs.netmaker.io/docs/server-installation/identity-provider-integration-guide" target="_blank" rel="noopener">docs</a> for more information.
		</em>
		<p>
