...
const (
	...
	ParticipantType_PARTICIPANT_HOST        ParticipantType = 1
	ParticipantType_PARTICIPANT_USER        ParticipantType = 2
	ParticipantType_PARTICIPANT_EXTCLIENT   ParticipantType = 3
	ParticipantType_PARTICIPANT_EXTERNAL    ParticipantType = 4 // anything not part of the Netmaker network
)
...
type FlowEvent struct {
	...
	NetworkId string `protobuf:"bytes,3,opt,name=network_id,json=networkId,proto3" json:"network_id,omitempty"` // Netmaker network the flow belongs to
	HostId    string `protobuf:"bytes,4,opt,name=host_id,json=hostId,proto3" json:"host_id,omitempty"`          // node reporting this event (observer)
	// L3/L4 metadata
	Protocol  uint32    `protobuf:"varint,5,opt,name=protocol,proto3" json:"protocol,omitempty"` // IP protocol number
	...
	SrcIp string `protobuf:"bytes,11,opt,name=src_ip,json=srcIp,proto3" json:"src_ip,omitempty"` // raw source IP string
	DstIp string `protobuf:"bytes,12,opt,name=dst_ip,json=dstIp,proto3" json:"dst_ip,omitempty"` // raw destination IP string
	// Timestamps (milliseconds since epoch)
	StartTsMs int64 `protobuf:"varint,13,opt,name=start_ts_ms,json=startTsMs,proto3" json:"start_ts_ms,omitempty"` // first-packet timestamp (agent clock)
	EndTsMs   int64 `protobuf:"varint,14,opt,name=end_ts_ms,json=endTsMs,proto3" json:"end_ts_ms,omitempty"`       // last-packet timestamp (only for destroy)
...
type FlowRecord struct {
	...
	Src *FlowParticipant `protobuf:"bytes,4,opt,name=src,proto3" json:"src,omitempty"`
	Dst *FlowParticipant `protobuf:"bytes,5,opt,name=dst,proto3" json:"dst,omitempty"`
	// Protocol metadata
	...
	EndTsMs   int64 `protobuf:"varint,13,opt,name=end_ts_ms,json=endTsMs,proto3" json:"end_ts_ms,omitempty"`
	// Counters
	BytesSent   uint64 `protobuf:"varint,14,opt,name=bytes_sent,json=bytesSent,proto3" json:"bytes_sent,omitempty"`
	BytesRecv   uint64 `protobuf:"varint,15,opt,name=bytes_recv,json=bytesRecv,proto3" json:"bytes_recv,omitempty"`
	PacketsSent uint64 `protobuf:"varint,16,opt,name=packets_sent,json=packetsSent,proto3" json:"packets_sent,omitempty"`
	PacketsRecv uint64 `protobuf:"varint,17,opt,name=packets_recv,json=packetsRecv,proto3" json:"packets_recv,omitempty"`
	// Conntrack flags
...
func (x *FlowRecord) GetNetworkId() string {
	if x != nil {
		return x.NetworkId
	}
	return ""
...
func (x *FlowRecord) GetHostId() string {
	if x != nil {
		return x.HostId
	}
	return ""
...
func (x *FlowRecord) GetSrc() *FlowParticipant {
	if x != nil {
		return x.Src
	}
	return nil
...
func (x *FlowRecord) GetDst() *FlowParticipant {
	if x != nil {
		return x.Dst
	}
	return nil
...
func (x *FlowRecord) GetIcmpCode() uint32 {
	if x != nil {
		return x.IcmpCode
	}
	return 0
...
func (x *FlowRecord) GetStartTsMs() int64 {
	if x != nil {
		return x.StartTsMs
	}
	return 0
...
func (x *FlowRecord) GetEndTsMs() int64 {
	if x != nil {
		return x.EndTsMs
	}
	return 0
...
func (x *FlowRecord) GetBytesRecv() uint64 {
	if x != nil {
		return x.BytesRecv
	}
	return 0
...
func (x *FlowRecord) GetPacketsSent() uint64 {
	if x != nil {
		return x.PacketsSent
	}
	return 0
...
func (x *FlowRecord) GetPacketsRecv() uint64 {
	if x != nil {
		return x.PacketsRecv
	}
	return 0
...
func (x *FlowRecord) GetStatus() uint32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *FlowRecord) GetVersion() int64 {
	if x != nil {
		return x.Version
	}
	return 0
...
type FlowEnvelope struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	HostId        string                 `protobuf:"bytes,1,opt,name=host_id,json=hostId,proto3" json:"host_id,omitempty"`          // identifier of the sending agent
	NetworkId     string                 `protobuf:"bytes,2,opt,name=network_id,json=networkId,proto3" json:"network_id,omitempty"` // network this batch belongs to
	Seq           uint64                 `protobuf:"varint,3,opt,name=seq,proto3" json:"seq,omitempty"`                             // monotonically increasing batch number
	Events        []*FlowEvent           `protobuf:"bytes,4,rep,name=events,proto3" json:"events,omitempty"`
	BatchTsMs     int64                  `protobuf:"varint,5,opt,name=batch_ts_ms,json=batchTsMs,proto3" json:"batch_ts_ms,omitempty"` // when agent formed the batch
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FlowEnvelope) GetNetworkId() string {
	if x != nil {
		return x.NetworkId
	}
	return ""
...
func (x *FlowEnvelope) GetSeq() uint64 {
	if x != nil {
		return x.Seq
	}
	return 0
...
func (x *FlowEnvelope) GetBatchTsMs() int64 {
	if x != nil {
		return x.BatchTsMs
	}
	return 0
...
type FlowResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AckSeq        uint64                 `protobuf:"varint,1,opt,name=ack_seq,json=ackSeq,proto3" json:"ack_seq,omitempty"` // matching the seq in FlowEnvelope
	Success       bool                   `protobuf:"varint,2,opt,name=success,proto3" json:"success,omitempty"`             // true if batch was accepted
	Error         string                 `protobuf:"bytes,3,opt,name=error,proto3" json:"error,omitempty"`                  // optional error information
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_grpc_flow_flow_proto_rawDesc = "" +
	...
	"\x0eparticipant_id\x18\x03 \x01(\tR\rparticipantId\"\xee\x04\n" +
	"\tFlowEvent\x12,\n" +
	...
	"\tdirection\x18\n" +
	" \x01(\x0e2\x18.netmaker.flow.DirectionR\tdirection\x12\x15\n" +
	"\x06src_ip\x18\v \x01(\tR\x05srcIp\x12\x15\n" +
	"\x06dst_ip\x18\f \x01(\tR\x05dstIp\x12\x1e\n" +
	...
	"\aversion\x18\x14 \x01(\x03R\aversion\"\xf7\x04\n" +
	"\n" +
	"FlowRecord\x12\x17\n" +
	"\aflow_id\x18\x01 \x01(\tR\x06flowId\x12\x1d\n" +
	"\n" +
	"network_id\x18\x02 \x01(\tR\tnetworkId\x12\x17\n" +
	"\ahost_id\x18\x03 \x01(\tR\x06hostId\x120\n" +
	"\x03src\x18\x04 \x01(\v2\x1e.netmaker.flow.FlowParticipantR\x03src\x120\n" +
	"\x03dst\x18\x05 \x01(\v2\x1e.netmaker.flow.FlowParticipantR\x03dst\x12\x1a\n" +
	...
	"\tdirection\x18\v \x01(\x0e2\x18.netmaker.flow.DirectionR\tdirection\x12\x1e\n" +
	"\vstart_ts_ms\x18\f \x01(\x03R\tstartTsMs\x12\x1a\n" +
	"\tend_ts_ms\x18\r \x01(\x03R\aendTsMs\x12\x1d\n" +
	"\n" +
	"bytes_sent\x18\x0e \x01(\x04R\tbytesSent\x12\x1d\n" +
	"\n" +
	"bytes_recv\x18\x0f \x01(\x04R\tbytesRecv\x12!\n" +
	"\fpackets_sent\x18\x10 \x01(\x04R\vpacketsSent\x12!\n" +
	"\fpackets_recv\x18\x11 \x01(\x04R\vpacketsRecv\x12\x16\n" +
	"\x06status\x18\x12 \x01(\rR\x06status\x12\x18\n" +
	"\aversion\x18\x13 \x01(\x03R\aversion\"\xaa\x01\n" +
	"\fFlowEnvelope\x12\x17\n" +
	"\ahost_id\x18\x01 \x01(\tR\x06hostId\x12\x1d\n" +
	"\n" +
	"network_id\x18\x02 \x01(\tR\tnetworkId\x12\x10\n" +
	"\x03seq\x18\x03 \x01(\x04R\x03seq\x120\n" +
	"\x06events\x18\x04 \x03(\v2\x18.netmaker.flow.FlowEventR\x06events\x12\x1e\n" +
	"\vbatch_ts_ms\x18\x05 \x01(\x03R\tbatchTsMs\"W\n" +
	"\fFlowResponse\x12\x17\n" +
	"\aack_seq\x18\x01 \x01(\x04R\x06ackSeq\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12\x14\n" +
	"\x05error\x18\x03 \x01(\tR\x05error*K\n" +
	"\tEventType\x12\x1a\n" +
	"\x16EVENT_TYPE_UNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vEVENT_START\x10\x01\x12\x11\n" +
	"\rEVENT_DESTROY\x10\x02*\x8f\x01\n" +
	"\x0fParticipantType\x12\x1b\n" +
	"\x17PARTICIPANT_UNSPECIFIED\x10\x00\x12\x14\n" +
	"\x10PARTICIPANT_HOST\x10\x01\x12\x14\n" +
	"\x10PARTICIPANT_USER\x10\x02\x12\x19\n" +
	"\x15PARTICIPANT_EXTCLIENT\x10\x03\x12\x18\n" +
	"\x14PARTICIPANT_EXTERNAL\x10\x04*A\n" +
	"\tDirection\x12\x13\n" +
...
var file_grpc_flow_flow_proto_goTypes = []any{
	...
	(*FlowRecord)(nil),      // 5: netmaker.flow.FlowRecord
...
var file_grpc_flow_flow_proto_depIdxs = []int32{
	...
	3, // 3: netmaker.flow.FlowRecord.src:type_name -> netmaker.flow.FlowParticipant
	3, // 4: netmaker.flow.FlowRecord.dst:type_name -> netmaker.flow.FlowParticipant
	2, // 5: netmaker.flow.FlowRecord.direction:type_name -> netmaker.flow.Direction
	4, // 6: netmaker.flow.FlowEnvelope.events:type_name -> netmaker.flow.FlowEvent
	6, // 7: netmaker.flow.FlowService.StreamFlows:input_type -> netmaker.flow.FlowEnvelope
	7, // 8: netmaker.flow.FlowService.StreamFlows:output_type -> netmaker.flow.FlowResponse
