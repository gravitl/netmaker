...
**This script is intended for experimenting with Netmaker. For production installations, visit the [Install Docs](https://netmaker.readthedocs.io/en/develop/install.html).**
